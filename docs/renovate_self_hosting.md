...
Once the custom manager is configured, annotate any `hcloud_server` resources in your Terraform files (e.g., `cluster/apps/networking/towonel/ingress-vps/main.tf`):
